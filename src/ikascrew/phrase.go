...
func init() {
	...
	fonts[0] = opencv.FontQt("Times", 20, color1, opencv.CV_FONT_BOLD, opencv.CV_STYLE_NORMAL, 5)
	fonts[1] = opencv.FontQt("Times", 20, color2, opencv.CV_FONT_BOLD, opencv.CV_STYLE_NORMAL, 5)
	fonts[2] = opencv.FontQt("Times", 20, color3, opencv.CV_FONT_BOLD, opencv.CV_STYLE_NORMAL, 5)
	fonts[3] = opencv.FontQt("Times", 20, color4, opencv.CV_FONT_BOLD, opencv.CV_STYLE_NORMAL, 5)
	fonts[4] = opencv.FontQt("Times", 20, color5, opencv.CV_FONT_BOLD, opencv.CV_STYLE_NORMAL, 5)
